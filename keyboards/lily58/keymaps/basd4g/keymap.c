...
#define MT_CE       MT(MOD_LCTL, KC_ENT)
...
[_QWERTY] = LAYOUT( \
  ...
  KC_MHEN, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_LBRC, KC_RBRC, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_HENK, \
                             KC_LCTL, KC_LGUI, LOWER  , MT_SS  , MT_CE  , RAISE  , KC_BSPC, KC_LALT \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
